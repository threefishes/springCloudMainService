...
public class Task {
    ...
    public Integer getServiceCale() {
        return serviceCale;
    }

    public void setServiceCale(Integer serviceCale) {
        this.serviceCale = serviceCale;
    }
    ...
    public void setTaskSn(String taskSn) {
        this.taskSn = taskSn == null ? null : taskSn.trim();
    }
