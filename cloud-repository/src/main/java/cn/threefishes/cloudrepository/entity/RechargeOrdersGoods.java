...
public class RechargeOrdersGoods {
    ...
    private Integer virtualOverdueRefund;

    private BigDecimal onlinePayPrice;

    private BigDecimal allOnlinePayPrice;
    ...
    public void setRechargeDeno(String rechargeDeno) {
        this.rechargeDeno = rechargeDeno == null ? null : rechargeDeno.trim();
    }
    ...
    public Integer getRefundApplyed() {
        return refundApplyed;
    }

    public void setRefundApplyed(Integer refundApplyed) {
        this.refundApplyed = refundApplyed;
    }
    ...
    public BigDecimal getAllOnlinePayPrice() {
        return allOnlinePayPrice;
    }

    public void setAllOnlinePayPrice(BigDecimal allOnlinePayPrice) {
        this.allOnlinePayPrice = allOnlinePayPrice;
    }
